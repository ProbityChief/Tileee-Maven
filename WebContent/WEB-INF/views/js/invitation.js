...
function obtenirrand() {
	select = document.querySelector("#selecttag");
	choice = select.selectedIndex;
	divrand = document.querySelector("#randtag");
	divrand.innerHTML = select.options[choice].value;
	console.log(select.options[choice].value);
}